...
/*
 ...
 This structure defines the locking mechanism associated with ITS

*/
#define ITS_LOCK_VERSION 1
...
extern void gic_v3_set_paddr_range(const paddr_t gicd, const paddr_t gicr, size_t gicr_size, const paddr_t gits);
