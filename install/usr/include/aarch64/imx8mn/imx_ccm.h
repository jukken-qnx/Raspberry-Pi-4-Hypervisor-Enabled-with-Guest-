...
#define IMX_CCM_GPR0n_SET(n)                    (0x004 + (4 * n))   /* General Purpose Register, Set */
#define IMX_CCM_GPR0n_CLR(n)                    (0x008 + (4 * n))   /* General Purpose Register, Clear */
#define IMX_CCM_GPR0n_TOG(n)                    (0x00C + (4 * n))   /* General Purpose Register, Toggle */
...
#define IMX_CCM_TARGET_GPU_CORE                 3U
#define IMX_CCM_TARGET_GPU_SHADER               4U
...
#define IMX_CCM_CCGR_CM7_ATCLK                  6U
...
#define IMX_CCM_CCGR_RESERVED37                 37U
...
#define IMX_CCM_CCGR_RESERVED86                 86U
#define IMX_CCM_CCGR_GPU                        87U
#define IMX_CCM_CCGR_ASRC                       88U
#define IMX_CCM_CCGR_RESERVED89                 89U
#define IMX_CCM_CCGR_RESERVED90                 90U
...
#define IMX_CCM_CCGR_RESERVED99                 99U
#define IMX_CCM_CCGR_RESERVED100                100U
#define IMX_CCM_CCGR_SAI7                       101U
