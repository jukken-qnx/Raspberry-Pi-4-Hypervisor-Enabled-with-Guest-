...
static int sdhci_pwr( sdio_hc_t *hc, uint32_t vdd )
{
    sdhci_hc_t      *sdhc;
    uintptr_t       base;
    uint32_t        hctl;
...
static int sdhci_bus_mode( sdio_hc_t *hc, uint32_t bus_mode )
{
#ifdef SDHCI_DWC_DEBUG
...
static int sdhci_bus_width( sdio_hc_t *hc, uint32_t width )
{
    sdhci_hc_t      *sdhc;
    uintptr_t       base;
    uint32_t        hctl;
...
// dwc function
static int sdhci_dwc_clk( sdio_hc_t *hc, uint32_t clk )
{
    sdhci_dwc_t *dwchc;
    sdhci_hc_t  *sdhc;
    uintptr_t   base;
...
static int sdhci_dwc_timing( sdio_hc_t *hc, uint32_t timing )
{
    sdhci_hc_t      *sdhc;
    sdhci_dwc_t     *dwchc;
    uintptr_t       base;
...
static int sdhci_signal_voltage( sdio_hc_t *hc, uint32_t signal_voltage )
{
    sdhci_hc_t      *sdhc;
    uintptr_t       base;
    uint32_t        sctl;
...
static int sdhci_drv_type( sdio_hc_t *hc, uint32_t type )
{
    sdhci_hc_t      *sdhc;
    uintptr_t       base;
    uint16_t        hctl2;
...
static int sdhci_tune( sdio_hc_t *hc, uint32_t op )
{
    sdhci_hc_t          *sdhc;
    struct sdio_cmd     *cmd;
    uintptr_t           base;
